...
"""
End-to-end support ticket workflow.

This module connects the individual chains into one readable pipeline:
triage → routing → case analysis → resolution → response → final result.
"""
